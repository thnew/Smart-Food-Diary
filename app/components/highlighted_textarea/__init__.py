...
if not _RELEASE:
    _component_func = components.declare_component(
        # We give the component a simple, descriptive name ("highlighted_textarea"
        # does not fit this bill, so please choose something better for your
        # own component :)
        "highlighted_textarea",
    ...
    _component_func = components.declare_component("highlighted_textarea", path=build_dir)
